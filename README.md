...
The Gomoku board UI in [gomoku.html](file:///C:/AAAAAAAAAAA_temp/desktop/Hephaestus_Repository/Docs_Repositories/Blog/Vucius.github.io/gomoku.html) requires an active backend server to run the AI engine.
